...
/**
 * PaymentCondition Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaymentCondition implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentCondition';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_term_days'] === null) {
            $invalidProperties[] = "'payment_term_days' can't be null";
        }
     ...
     * Sets discount_days
     *
     * @param int $discount_days discount_days
     *
     * @return self
     */
     ...
     *
     * @param int $payment_term_days payment_term_days
     *
     * @return self
     */

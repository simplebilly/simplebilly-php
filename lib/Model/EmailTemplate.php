...
class EmailTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setBody($body)
    {
        ...
        if ((mb_strlen($body) < 1)) {
            throw new \InvalidArgumentException('invalid length for $body when calling EmailTemplate., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling EmailTemplate., must be bigger than or equal to 1.');
        }
    ...
    public function setSubject($subject)
    {
        ...
        if ((mb_strlen($subject) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling EmailTemplate., must be bigger than or equal to 1.');
        }

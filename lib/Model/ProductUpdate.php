...
class ProductUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['product_code']) && (mb_strlen($this->container['product_code']) > 100)) {
    ...
    public function setBarcode($barcode)
    {
        ...
        if (!is_null($barcode) && (mb_strlen($barcode) > 100)) {
            throw new \InvalidArgumentException('invalid length for $barcode when calling ProductUpdate., must be smaller than or equal to 100.');
        }
    ...
    public function setBrand($brand)
    {
        ...
        if (!is_null($brand) && (mb_strlen($brand) > 255)) {
            throw new \InvalidArgumentException('invalid length for $brand when calling ProductUpdate., must be smaller than or equal to 255.');
        }
    ...
    public function setCategoryId($category_id)
    {
        ...
        if (!is_null($category_id) && (mb_strlen($category_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $category_id when calling ProductUpdate., must be smaller than or equal to 50.');
        }
    ...
    public function setDefaultLedgerAccount($default_ledger_account)
    {
        ...
        if (!is_null($default_ledger_account) && (mb_strlen($default_ledger_account) > 50)) {
            throw new \InvalidArgumentException('invalid length for $default_ledger_account when calling ProductUpdate., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ProductUpdate., must be smaller than or equal to 5000.');
        }
    ...
    public function setGtin($gtin)
    {
        ...
        if (!is_null($gtin) && (mb_strlen($gtin) > 50)) {
            throw new \InvalidArgumentException('invalid length for $gtin when calling ProductUpdate., must be smaller than or equal to 50.');
        }
    ...
    public function setImageLink($image_link)
    {
        ...
        if (!is_null($image_link) && (mb_strlen($image_link) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $image_link when calling ProductUpdate., must be smaller than or equal to 2048.');
        }
    ...
    public function setLink($link)
    {
        ...
        if (!is_null($link) && (mb_strlen($link) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $link when calling ProductUpdate., must be smaller than or equal to 2048.');
        }
    ...
    public function setMpn($mpn)
    {
        ...
        if (!is_null($mpn) && (mb_strlen($mpn) > 100)) {
            throw new \InvalidArgumentException('invalid length for $mpn when calling ProductUpdate., must be smaller than or equal to 100.');
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProductUpdate., must be smaller than or equal to 255.');
        }
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProductUpdate., must be bigger than or equal to 1.');
        }
    ...
    public function setPackageWeightUnit($package_weight_unit)
    {
        ...
        if (!is_null($package_weight_unit) && (mb_strlen($package_weight_unit) > 10)) {
            throw new \InvalidArgumentException('invalid length for $package_weight_unit when calling ProductUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setProductCode($product_code)
    {
        ...
        if (!is_null($product_code) && (mb_strlen($product_code) > 100)) {
            throw new \InvalidArgumentException('invalid length for $product_code when calling ProductUpdate., must be smaller than or equal to 100.');
        }
        if (!is_null($product_code) && (mb_strlen($product_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $product_code when calling ProductUpdate., must be bigger than or equal to 1.');
        }
    ...
    public function setProductType($product_type)
    {
        ...
        if (!is_null($product_type) && (mb_strlen($product_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $product_type when calling ProductUpdate., must be smaller than or equal to 50.');
        }
    ...
    public function setSku($sku)
    {
        ...
        if (!is_null($sku) && (mb_strlen($sku) > 100)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling ProductUpdate., must be smaller than or equal to 100.');
        }
        if (!is_null($sku) && (mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling ProductUpdate., must be bigger than or equal to 1.');
        }
    ...
    public function setTrackBatch($track_batch)
    {
        if (is_null($track_batch)) {
            array_push($this->openAPINullablesSetToNull, 'track_batch');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('track_batch', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setTrackSerial($track_serial)
    {
        if (is_null($track_serial)) {
            array_push($this->openAPINullablesSetToNull, 'track_serial');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('track_serial', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setWeightUnit($weight_unit)
    {
        ...
        if (!is_null($weight_unit) && (mb_strlen($weight_unit) > 10)) {
            throw new \InvalidArgumentException('invalid length for $weight_unit when calling ProductUpdate., must be smaller than or equal to 10.');
        }

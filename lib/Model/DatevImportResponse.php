...
/**
 * DatevImportResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DatevImportResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DatevImportResponse';
    ...
    protected static $openAPITypes = [
        'count' => 'int',
        'filename' => 'string',
        'rows' => '\OpenAPI\Client\Model\DatevImportRow[]'
    ];
    ...
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling DatevImportResponse., must be bigger than or equal to 0.');
        }
     ...
     * Gets rows
     *
     * @return \OpenAPI\Client\Model\DatevImportRow[]
     */
     ...
     * Sets rows
     *
     * @param \OpenAPI\Client\Model\DatevImportRow[] $rows rows
     *
     * @return self
     */

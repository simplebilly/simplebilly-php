 ...
 */
class AccountOverview implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AccountOverview';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['credit_total'] === null) {
            $invalidProperties[] = "'credit_total' can't be null";
        }
        if ($this->container['debit_total'] === null) {
            $invalidProperties[] = "'debit_total' can't be null";
        }

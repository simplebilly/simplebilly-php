...
/**
 * PackingQueue Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PackingQueue implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PackingQueue';
    ...
    protected static $openAPITypes = [
        'items' => '\OpenAPI\Client\Model\PackingQueueItem[]',
        'page' => 'int',
        'page_size' => 'int',
        'total_count' => 'int'
    ];
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\PackingQueueItem[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\PackingQueueItem[] $items items
     *
     * @return self
     */
    ...
    public function setPage($page)
    {
        ...
        if (($page < 0)) {
            throw new \InvalidArgumentException('invalid value for $page when calling PackingQueue., must be bigger than or equal to 0.');
        }
    ...
    public function setPageSize($page_size)
    {
        ...
        if (($page_size < 0)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling PackingQueue., must be bigger than or equal to 0.');
        }
    ...
    public function setTotalCount($total_count)
    {
        ...
        if (($total_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_count when calling PackingQueue., must be bigger than or equal to 0.');
        }

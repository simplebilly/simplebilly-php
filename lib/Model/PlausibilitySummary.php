...
/**
 * PlausibilitySummary Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PlausibilitySummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PlausibilitySummary';
    ...
    protected static $openAPITypes = [
        'errors' => 'int',
        'overall_status' => '\OpenAPI\Client\Model\CheckStatus',
        'passed' => 'int',
        'total_checks' => 'int',
        'warnings' => 'int'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['passed'] < 0)) {
            $invalidProperties[] = "invalid value for 'passed', must be bigger than or equal to 0.";
        }

        if ($this->container['total_checks'] === null) {
            $invalidProperties[] = "'total_checks' can't be null";
        }
        if (($this->container['total_checks'] < 0)) {
            $invalidProperties[] = "invalid value for 'total_checks', must be bigger than or equal to 0.";
        }
    ...
    public function setErrors($errors)
    {
        ...
        if (($errors < 0)) {
            throw new \InvalidArgumentException('invalid value for $errors when calling PlausibilitySummary., must be bigger than or equal to 0.');
        }
     ...
     * Gets overall_status
     *
     * @return \OpenAPI\Client\Model\CheckStatus
     */
     ...
     * Sets overall_status
     *
     * @param \OpenAPI\Client\Model\CheckStatus $overall_status overall_status
     *
     * @return self
     */
    ...
    public function setPassed($passed)
    {
        ...
        if (($passed < 0)) {
            throw new \InvalidArgumentException('invalid value for $passed when calling PlausibilitySummary., must be bigger than or equal to 0.');
        }
    ...
    public function setTotalChecks($total_checks)
    {
        ...
        if (($total_checks < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_checks when calling PlausibilitySummary., must be bigger than or equal to 0.');
        }
    ...
    public function setWarnings($warnings)
    {
        ...
        if (($warnings < 0)) {
            throw new \InvalidArgumentException('invalid value for $warnings when calling PlausibilitySummary., must be bigger than or equal to 0.');
        }

...
/**
 * TrainingAssignmentUpdate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrainingAssignmentUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TrainingAssignmentUpdate';
    ...
    public function setNotes($notes)
    {
        ...
        if (!is_null($notes) && (mb_strlen($notes) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling TrainingAssignmentUpdate., must be smaller than or equal to 1000.');
        }
    ...
    public function setTrainingId($training_id)
    {
        if (is_null($training_id)) {
            array_push($this->openAPINullablesSetToNull, 'training_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('training_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }

...
/**
 * SupplierInvoiceCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SupplierInvoiceCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SupplierInvoiceCreate';
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\SupplierInvoiceStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\SupplierInvoiceStatus $status One of: draft | matched | has_variances | posted | cancelled
     *
     * @return self
     */

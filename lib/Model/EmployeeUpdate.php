...
/**
 * EmployeeUpdate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EmployeeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EmployeeUpdate';
    ...
    public function setAddress($address)
    {
        ...
        if (!is_null($address) && (mb_strlen($address) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address when calling EmployeeUpdate., must be smaller than or equal to 255.');
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $city when calling EmployeeUpdate., must be smaller than or equal to 100.');
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling EmployeeUpdate., must be smaller than or equal to 100.');
        }
        if (!is_null($first_name) && (mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling EmployeeUpdate., must be bigger than or equal to 1.');
        }
    ...
    public function setJobTitle($job_title)
    {
        ...
        if (!is_null($job_title) && (mb_strlen($job_title) > 100)) {
            throw new \InvalidArgumentException('invalid length for $job_title when calling EmployeeUpdate., must be smaller than or equal to 100.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling EmployeeUpdate., must be smaller than or equal to 100.');
        }
        if (!is_null($last_name) && (mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling EmployeeUpdate., must be bigger than or equal to 1.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if (!is_null($phone) && (!preg_match("/^\\+?[0-9\\s\\-\\(\\)]{7,20}$/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling EmployeeUpdate., must conform to the pattern /^\\+?[0-9\\s\\-\\(\\)]{7,20}$/.");
        }
    ...
    public function setState($state)
    {
        ...
        if (!is_null($state) && (mb_strlen($state) > 100)) {
            throw new \InvalidArgumentException('invalid length for $state when calling EmployeeUpdate., must be smaller than or equal to 100.');
        }
    ...
    public function setZip($zip)
    {
        ...
        if (!is_null($zip) && (mb_strlen($zip) > 20)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling EmployeeUpdate., must be smaller than or equal to 20.');
        }

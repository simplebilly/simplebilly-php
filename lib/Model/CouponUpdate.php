...
class CouponUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCode($code)
    {
        ...
        if (!is_null($code) && (mb_strlen($code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CouponUpdate., must be smaller than or equal to 50.');
        }
        if (!is_null($code) && (mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CouponUpdate., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CouponUpdate., must be smaller than or equal to 500.');
        }
     ...
     * Gets discount_type
     *
     * @return \OpenAPI\Client\Model\DiscountType|null
     */
     ...
     * Sets discount_type
     *
     * @param \OpenAPI\Client\Model\DiscountType|null $discount_type discount_type
     *
     * @return self
     */
     ...
     * Sets discount_value
     *
     * @param string|null $discount_value discount_value
     *
     * @return self
     */
    ...
    public function setIsCombineable($is_combineable)
    {
        if (is_null($is_combineable)) {
            array_push($this->openAPINullablesSetToNull, 'is_combineable');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_combineable', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }

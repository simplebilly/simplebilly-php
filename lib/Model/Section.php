...
class Section implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('body_html_en', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['body_html_en'] === null) {
            $invalidProperties[] = "'body_html_en' can't be null";
        }
     ...
     * @return string
     */
    public function getBodyHtmlEn()
    {
        return $this->container['body_html_en'];
    }

    /**
     * Sets body_html_en
     *
     * @param string $body_html_en body_html_en
     *
     * @return self
     */
    public function setBodyHtmlEn($body_html_en)
    {
        if (is_null($body_html_en)) {
            throw new \InvalidArgumentException('non-nullable body_html_en cannot be null');
        }
        $this->container['body_html_en'] = $body_html_en;

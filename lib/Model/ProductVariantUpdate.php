...
class ProductVariantUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets product_id
     *
     * @param string|null $product_id The parent product this variant belongs to. References the product entity.
     *
     * @return self
     */
     ...
     * Sets sku
     *
     * @param string|null $sku Variant-specific SKU (must be unique per tenant).
     *
     * @return self
     */

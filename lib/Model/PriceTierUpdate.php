...
/**
 * PriceTierUpdate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PriceTierUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PriceTierUpdate';
     ...
     * Sets product_id
     *
     * @param string|null $product_id References the product entity.
     *
     * @return self
     */

 ...
 */
class OssReport implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OssReport';
    ...
    protected static $openAPITypes = [
        'dependencies' => '\OpenAPI\Client\Model\OssDependency[]',
        'total_count' => 'int'
    ];
     ...
     * Gets dependencies
     *
     * @return \OpenAPI\Client\Model\OssDependency[]
     */
     ...
     * Sets dependencies
     *
     * @param \OpenAPI\Client\Model\OssDependency[] $dependencies dependencies
     *
     * @return self
     */
    ...
    public function setTotalCount($total_count)
    {
        ...
        if (($total_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_count when calling OssReport., must be bigger than or equal to 0.');
        }

...
/**
 * TrackOrderRequest Class Doc Comment
 *
 * @category Class
 * @description Refresh tracking for a shipment from the live carrier API and store the latest status + events on the shipment row.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TrackOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TrackOrderRequest';

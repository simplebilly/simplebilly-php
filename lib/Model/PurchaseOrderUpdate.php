...
/**
 * PurchaseOrderUpdate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PurchaseOrderUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PurchaseOrderUpdate';
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\PurchaseOrderStatus|null
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\PurchaseOrderStatus|null $status One of: draft | ordered | partially_received | received | cancelled
     *
     * @return self
     */

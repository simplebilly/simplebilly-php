...
/**
 * Verfahrensdokumentation Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Verfahrensdokumentation implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Verfahrensdokumentation';
    ...
    protected static $openAPITypes = [
        'entries' => '\OpenAPI\Client\Model\ComplianceEntry[]',
        'generated_at' => 'string',
        'title' => 'string',
        'version' => 'string'
    ];
     ...
     * Gets entries
     *
     * @return \OpenAPI\Client\Model\ComplianceEntry[]
     */
     ...
     * Sets entries
     *
     * @param \OpenAPI\Client\Model\ComplianceEntry[] $entries entries
     *
     * @return self
     */

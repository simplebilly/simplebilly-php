...
/**
 * ApplicationFilter Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ApplicationFilter';
    ...
    public function setPage($page)
    {
        ...
        if (!is_null($page) && ($page < 0)) {
            throw new \InvalidArgumentException('invalid value for $page when calling ApplicationFilter., must be bigger than or equal to 0.');
        }
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size < 0)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling ApplicationFilter., must be bigger than or equal to 0.');
        }
     ...
     * Sets posting_id
     *
     * @param string|null $posting_id posting_id
     *
     * @return self
     */

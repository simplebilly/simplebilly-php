...
/**
 * InvoiceMatchRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceMatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'InvoiceMatchRequest';
    ...
    {
        $this->setIfExists('supplier_invoice_id', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['supplier_invoice_id'] === null) {
            $invalidProperties[] = "'supplier_invoice_id' can't be null";
        }
    ...
    {
        if (is_null($supplier_invoice_id)) {
            throw new \InvalidArgumentException('non-nullable supplier_invoice_id cannot be null');
        }

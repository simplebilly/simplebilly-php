...
class Employee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setAddress($address)
    {
        ...
        if (!is_null($address) && (mb_strlen($address) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address when calling Employee., must be smaller than or equal to 255.');
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $city when calling Employee., must be smaller than or equal to 100.');
        }
    ...
    public function setJobTitle($job_title)
    {
        ...
        if ((mb_strlen($job_title) > 100)) {
            throw new \InvalidArgumentException('invalid length for $job_title when calling Employee., must be smaller than or equal to 100.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if (!is_null($phone) && (!preg_match("/^\\+?[0-9\\s\\-\\(\\)]{7,20}$/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling Employee., must conform to the pattern /^\\+?[0-9\\s\\-\\(\\)]{7,20}$/.");
        }
    ...
    public function setState($state)
    {
        ...
        if (!is_null($state) && (mb_strlen($state) > 100)) {
            throw new \InvalidArgumentException('invalid length for $state when calling Employee., must be smaller than or equal to 100.');
        }
    ...
    public function setZip($zip)
    {
        ...
        if (!is_null($zip) && (mb_strlen($zip) > 20)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling Employee., must be smaller than or equal to 20.');
        }

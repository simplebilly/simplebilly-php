 ...
 */
class KontoReport implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'KontoReport';
    ...
    protected static $openAPITypes = [
        'generated_at' => 'string',
        'konten' => '\OpenAPI\Client\Model\KontoItem[]',
        'period' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('konten', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['konten'] === null) {
            $invalidProperties[] = "'konten' can't be null";
        }
     ...
     * Gets konten
     *
     * @return \OpenAPI\Client\Model\KontoItem[]
     */
    public function getKonten()
    {
        return $this->container['konten'];
    }

    /**
     * Sets konten
     *
     * @param \OpenAPI\Client\Model\KontoItem[] $konten konten
     *
     * @return self
     */
    ...
    {
        if (is_null($konten)) {
            throw new \InvalidArgumentException('non-nullable konten cannot be null');
        }
        $this->container['konten'] = $konten;

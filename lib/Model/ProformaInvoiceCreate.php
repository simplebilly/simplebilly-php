...
/**
 * ProformaInvoiceCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProformaInvoiceCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProformaInvoiceCreate';
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\ProformaInvoiceStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\ProformaInvoiceStatus $status `draft` | `sent` | `converted`.
     *
     * @return self
     */

 ...
 */
class AiConfigDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AiConfigDto';
     ...
     * Sets auto_reply
     *
     * @param bool|null $auto_reply auto_reply
     *
     * @return self
     */
    public function setAutoReply($auto_reply)
    {
        if (is_null($auto_reply)) {
            array_push($this->openAPINullablesSetToNull, 'auto_reply');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('auto_reply', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setSystemPrompt($system_prompt)
    {
        if (is_null($system_prompt)) {
            array_push($this->openAPINullablesSetToNull, 'system_prompt');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('system_prompt', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets trigger_on
     *
     * @param string[]|null $trigger_on trigger_on
     *
     * @return self
     */
    public function setTriggerOn($trigger_on)
    {
        if (is_null($trigger_on)) {
            array_push($this->openAPINullablesSetToNull, 'trigger_on');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('trigger_on', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }

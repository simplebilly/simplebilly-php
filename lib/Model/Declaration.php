...
class Declaration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 20000)) {
            throw new \InvalidArgumentException('invalid length for $text when calling Declaration., must be smaller than or equal to 20000.');
        }
        if ((mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling Declaration., must be bigger than or equal to 1.');
        }
    ...
    public function setVersion($version)
    {
        ...
        if ((mb_strlen($version) > 50)) {
            throw new \InvalidArgumentException('invalid length for $version when calling Declaration., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($version) < 1)) {
            throw new \InvalidArgumentException('invalid length for $version when calling Declaration., must be bigger than or equal to 1.');
        }

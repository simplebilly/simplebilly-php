...
class WebhookEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'attempts' => 'int',
        'channel' => 'string',
        'direction' => '\OpenAPI\Client\Model\WebhookDirection',
        'event_type' => 'string',
        'last_error' => 'string',
        'payload' => 'mixed',
        'status' => '\OpenAPI\Client\Model\WebhookEventStatus'
    ];
     ...
     * Sets channel
     *
     * @param string|null $channel source for inbound, target URL for outbound.
     *
     * @return self
     */
     ...
     * Gets direction
     *
     * @return \OpenAPI\Client\Model\WebhookDirection
     */
     ...
     * Sets direction
     *
     * @param \OpenAPI\Client\Model\WebhookDirection $direction inbound | outbound
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\WebhookEventStatus|null
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\WebhookEventStatus|null $status accepted | delivered | failed
     *
     * @return self
     */

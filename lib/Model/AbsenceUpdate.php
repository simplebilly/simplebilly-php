...
/**
 * AbsenceUpdate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AbsenceUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AbsenceUpdate';
    ...
    public function setAbsenceType($absence_type)
    {
        if (is_null($absence_type)) {
            array_push($this->openAPINullablesSetToNull, 'absence_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('absence_type', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setNotes($notes)
    {
        ...
        if (!is_null($notes) && (mb_strlen($notes) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling AbsenceUpdate., must be smaller than or equal to 2000.');
        }

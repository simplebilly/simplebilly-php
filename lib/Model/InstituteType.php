...
/**
 * InstituteType Class Doc Comment
 *
 * @category Class
...
class InstituteType
{
     ...
     */
    public const KEIN = 'kein';

    public const KREDITINSTITUT = 'kreditinstitut';

    public const FINANZDIENSTLEISTUNGSINSTITUT = 'finanzdienstleistungsinstitut';

    public const FINANZUNTERNEHMEN = 'finanzunternehmen';

    public const VERSICHERUNG = 'versicherung';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::KEIN,
            self::KREDITINSTITUT,
            self::FINANZDIENSTLEISTUNGSINSTITUT,
            self::FINANZUNTERNEHMEN,
            self::VERSICHERUNG
        ];
    }
}

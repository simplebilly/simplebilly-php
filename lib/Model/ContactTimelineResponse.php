...
/**
 * ContactTimelineResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactTimelineResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ContactTimelineResponse';
    ...
    protected static $openAPITypes = [
        'contact_id' => 'string',
        'events' => '\OpenAPI\Client\Model\TimelineEvent[]'
    ];
     ...
     * Sets events
     *
     * @param \OpenAPI\Client\Model\TimelineEvent[] $events events
     *
     * @return self
     */

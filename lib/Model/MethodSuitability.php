...
/**
 * MethodSuitability Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MethodSuitability implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MethodSuitability';
    ...
    protected static $openAPITypes = [
        'carrier' => 'string',
        'rate' => '\OpenAPI\Client\Model\ShippingRate',
        'reasons' => 'string[]',
        'service' => 'string',
        'suitable' => 'bool'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('suitable', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['suitable'] === null) {
            $invalidProperties[] = "'suitable' can't be null";
        }
     ...
     * Sets rate
     *
     * @param \OpenAPI\Client\Model\ShippingRate|null $rate rate
     *
     * @return self
     */
    ...
    {
        return $this->container['suitable'];
    }

    /**
     * Sets suitable
     *
     * @param bool $suitable suitable
     *
     * @return self
     */
    ...
    {
        if (is_null($suitable)) {
            throw new \InvalidArgumentException('non-nullable suitable cannot be null');
        }
        $this->container['suitable'] = $suitable;

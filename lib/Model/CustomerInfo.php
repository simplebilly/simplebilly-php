...
class CustomerInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('annual_volume', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['annual_volume'] === null) {
            $invalidProperties[] = "'annual_volume' can't be null";
        }
        if (($this->container['annual_volume'] < 0)) {
            $invalidProperties[] = "invalid value for 'annual_volume', must be bigger than or equal to 0.";
        }
    ...
    {
        return $this->container['annual_volume'];
    }

    /**
     * Sets annual_volume
     *
     * @param int $annual_volume annual_volume
     *
     * @return self
     */
    public function setAnnualVolume($annual_volume)
    {
        if (is_null($annual_volume)) {
            throw new \InvalidArgumentException('non-nullable annual_volume cannot be null');
        }
        if (($annual_volume < 0)) {
            throw new \InvalidArgumentException('invalid value for $annual_volume when calling CustomerInfo., must be bigger than or equal to 0.');
        }

        $this->container['annual_volume'] = $annual_volume;
     ...
     * Sets is_registered
     *
     * @param bool $is_registered is_registered
     *
     * @return self
     */

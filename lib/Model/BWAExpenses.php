 ...
 */
class BWAExpenses implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BWAExpenses';
    ...
    protected static $openAPITypes = [
        'expense_breakdown' => '\OpenAPI\Client\Model\ExpenseItem[]',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['expense_breakdown'] === null) {
            $invalidProperties[] = "'expense_breakdown' can't be null";
        }
     ...
     *
     * @return \OpenAPI\Client\Model\ExpenseItem[]
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ExpenseItem[] $expense_breakdown expense_breakdown
     *
     * @return self
     */

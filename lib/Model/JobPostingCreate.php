...
/**
 * JobPostingCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class JobPostingCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'JobPostingCreate';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['required_skills'] === null && !$this->isNullableSetToNull('required_skills')) {
            $invalidProperties[] = "'required_skills' is required";
        }
     ...
     * Sets description
     *
     * @param string $description What the job is; markdown/HTML.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling JobPostingCreate., must be bigger than or equal to 1.');
        }
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\JobPostingStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\JobPostingStatus $status draft | published | closed
     *
     * @return self
     */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling JobPostingCreate., must be bigger than or equal to 1.');
        }

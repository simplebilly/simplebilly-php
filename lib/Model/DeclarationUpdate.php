...
/**
 * DeclarationUpdate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeclarationUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DeclarationUpdate';
    ...
    public function setDeclarationType($declaration_type)
    {
        if (is_null($declaration_type)) {
            array_push($this->openAPINullablesSetToNull, 'declaration_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('declaration_type', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setIsCurrent($is_current)
    {
        if (is_null($is_current)) {
            array_push($this->openAPINullablesSetToNull, 'is_current');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_current', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setText($text)
    {
        ...
        if (!is_null($text) && (mb_strlen($text) > 20000)) {
            throw new \InvalidArgumentException('invalid length for $text when calling DeclarationUpdate., must be smaller than or equal to 20000.');
        }
        if (!is_null($text) && (mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling DeclarationUpdate., must be bigger than or equal to 1.');
        }
    ...
    public function setVersion($version)
    {
        ...
        if (!is_null($version) && (mb_strlen($version) > 50)) {
            throw new \InvalidArgumentException('invalid length for $version when calling DeclarationUpdate., must be smaller than or equal to 50.');
        }
        if (!is_null($version) && (mb_strlen($version) < 1)) {
            throw new \InvalidArgumentException('invalid length for $version when calling DeclarationUpdate., must be bigger than or equal to 1.');
        }

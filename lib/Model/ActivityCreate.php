...
/**
 * ActivityCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ActivityCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ActivityCreate';
     ...
     * Sets activity_type
     *
     * @param \OpenAPI\Client\Model\ActivityType $activity_type One of: call | email | meeting | task | note
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\ActivityStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\ActivityStatus $status One of: open | done | cancelled
     *
     * @return self
     */

...
/**
 * UpsCredentials Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpsCredentials implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpsCredentials';
     ...
     * Sets client_id
     *
     * @param string $client_id OAuth 2.0 client credentials from developer.ups.com.
     *
     * @return self
     */
     ...
     * Sets shipper_number
     *
     * @param string|null $shipper_number UPS account number; required for label creation, optional for rates/tracking.
     *
     * @return self
     */
    public function setShipperNumber($shipper_number)
    {
        if (is_null($shipper_number)) {
            array_push($this->openAPINullablesSetToNull, 'shipper_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('shipper_number', $nullablesSetToNull);
            if ($index !== FALSE) {

...
/**
 * ComplianceEntry Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ComplianceEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ComplianceEntry';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['regulations'] === null) {
            $invalidProperties[] = "'regulations' can't be null";
        }
     ...
     * Sets regulations
     *
     * @param string[] $regulations regulations
     *
     * @return self
     */

...
/**
 * PlausibilityCheck Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PlausibilityCheck implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PlausibilityCheck';
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\OpenAPI\Client\Model\CheckStatus'
    ];
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\CheckStatus $status status
     *
     * @return self
     */

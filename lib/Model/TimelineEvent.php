 ...
 *
 * @category Class
 * @description Single timeline entry aggregated from the contact&#39;s activity across all related modules (communications, quotations, orders, invoices, documents).
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class TimelineEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets date
     *
     * @param string $date RFC3339 UTC timestamp for sorting.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id Source record id (stringified).
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Source module: communication | quotation | order | invoice | attachment.
     *
     * @return self
     */

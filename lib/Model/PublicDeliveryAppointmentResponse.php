...
/**
 * PublicDeliveryAppointmentResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PublicDeliveryAppointmentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PublicDeliveryAppointmentResponse';
    ...
    protected static $setters = [
        ...
        'confirmation_hint' => 'setConfirmationHint',
        'message' => 'setMessage',
        'status' => 'setStatus'
    ];
    ...
    protected static $getters = [
        ...
        'confirmation_hint' => 'getConfirmationHint',
        'message' => 'getMessage',
        'status' => 'getStatus'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('confirmation_hint', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['confirmation_hint'] === null) {
            $invalidProperties[] = "'confirmation_hint' can't be null";
        }
    ...
    /**
     * Gets confirmation_hint
     *
     * @return string
     */
    public function getConfirmationHint()
    {
        return $this->container['confirmation_hint'];
    }

    /**
     * Sets confirmation_hint
     *
     * @param string $confirmation_hint Carries the status-check token (email is out of scope for now).
     *
     * @return self
     */
    public function setConfirmationHint($confirmation_hint)
    {
        if (is_null($confirmation_hint)) {
            throw new \InvalidArgumentException('non-nullable confirmation_hint cannot be null');
        }
        $this->container['confirmation_hint'] = $confirmation_hint;

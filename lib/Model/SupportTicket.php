 ...
 */
class SupportTicket implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SupportTicket';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['first_message_at'] === null) {
            $invalidProperties[] = "'first_message_at' can't be null";
        }
        ...
        if ($this->container['tags'] === null && !$this->isNullableSetToNull('tags')) {
            $invalidProperties[] = "'tags' is required";
        }
     ...
     *
     * @param \DateTime $first_message_at first_message_at
     *
     * @return self
     */
     ...
     * Gets priority
     *
     * @return \OpenAPI\Client\Model\TicketPriority
     */
     ...
     * Sets priority
     *
     * @param \OpenAPI\Client\Model\TicketPriority $priority priority
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\SupportTicketStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\SupportTicketStatus $status status
     *
     * @return self
     */

...
/**
 * OffenlegungItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OffenlegungItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OffenlegungItem';
     ...
     * Sets exists
     *
     * @param bool $exists Ob die zugrunde liegenden Daten im System vorhanden sind.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Bezeichnung des Offenlegungsbestandteils (§ 325 Abs. 1 HGB).
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string $source Woher der Bestandteil stammt bzw. fehlt.
     *
     * @return self
     */

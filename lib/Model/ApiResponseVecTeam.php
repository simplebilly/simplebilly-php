...
/**
 * ApiResponseVecTeam Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiResponseVecTeam implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ApiResponse_Vec_Team';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\ApiResponseTeamData[]',
        'error' => 'string',
        'message' => 'string',
        'success' => 'bool'
    ];
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ApiResponseTeamData[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ApiResponseTeamData[]|null $data data
     *
     * @return self
     */

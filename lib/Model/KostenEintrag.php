...
/**
 * KostenEintrag Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class KostenEintrag implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'KostenEintrag';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('datum', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['beschreibung'] === null) {
            $invalidProperties[] = "'beschreibung' can't be null";
        }
        if ($this->container['betrag'] === null) {
            $invalidProperties[] = "'betrag' can't be null";
        }
        if ($this->container['datum'] === null) {
            $invalidProperties[] = "'datum' can't be null";
        }
    ...
    {
        if (is_null($datum)) {
            throw new \InvalidArgumentException('non-nullable datum cannot be null');
        }

...
/**
 * AnlageGKfzHinweis Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AnlageGKfzHinweis implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AnlageGKfzHinweis';
    ...
    protected static $setters = [
        ...
        'privat_anteil_prozent' => 'setPrivatAnteilProzent'
    ];
    ...
    protected static $getters = [
        ...
        'privat_anteil_prozent' => 'getPrivatAnteilProzent'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('kennzeichen', $data ?? [], null);
        $this->setIfExists('privat_anteil_prozent', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['privat_anteil_prozent'] === null) {
            $invalidProperties[] = "'privat_anteil_prozent' can't be null";
        }
    ...
    {
        if (is_null($kennzeichen)) {
            throw new \InvalidArgumentException('non-nullable kennzeichen cannot be null');
        }
    ...
    /**
     * Gets privat_anteil_prozent
     *
     * @return string
     */
    public function getPrivatAnteilProzent()
    {
        return $this->container['privat_anteil_prozent'];
    }

    /**
     * Sets privat_anteil_prozent
     *
     * @param string $privat_anteil_prozent privat_anteil_prozent
     *
     * @return self
     */
    public function setPrivatAnteilProzent($privat_anteil_prozent)
    {
        if (is_null($privat_anteil_prozent)) {
            throw new \InvalidArgumentException('non-nullable privat_anteil_prozent cannot be null');
        }
        $this->container['privat_anteil_prozent'] = $privat_anteil_prozent;

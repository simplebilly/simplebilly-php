...
/**
 * PayrollMonth Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PayrollMonth implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PayrollMonth';
    ...
    public function setMonth($month)
    {
        ...
        if (($month < 0)) {
            throw new \InvalidArgumentException('invalid value for $month when calling PayrollMonth., must be bigger than or equal to 0.');
        }

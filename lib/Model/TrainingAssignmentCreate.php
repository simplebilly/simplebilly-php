...
/**
 * TrainingAssignmentCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrainingAssignmentCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TrainingAssignmentCreate';
    ...
    public function setNotes($notes)
    {
        ...
        if (!is_null($notes) && (mb_strlen($notes) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling TrainingAssignmentCreate., must be smaller than or equal to 1000.');
        }

...
class WebhookSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets event_type
     *
     * @param string $event_type Event type to react to (e.g. \"order.created\"); \"*\" = all events.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Human label (e.g. \"Warehouse app\").
     *
     * @return self
     */
     ...
     * Sets secret
     *
     * @param string $secret Shared secret for HMAC-SHA256 signature, sent as X-Signature.
     *
     * @return self
     */

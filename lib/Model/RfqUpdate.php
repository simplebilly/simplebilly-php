 ...
 */
class RfqUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RfqUpdate';
     ...
     * Sets rfq_number
     *
     * @param string|null $rfq_number rfq_number
     *
     * @return self
     */
    public function setRfqNumber($rfq_number)
    {
        if (is_null($rfq_number)) {
            array_push($this->openAPINullablesSetToNull, 'rfq_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('rfq_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\RfqStatus|null
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\RfqStatus|null $status One of: draft | sent | offer_received | rejected | converted
     *
     * @return self
     */

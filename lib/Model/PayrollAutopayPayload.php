...
/**
 * PayrollAutopayPayload Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PayrollAutopayPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PayrollAutopayPayload';
    ...
    {
        $this->setIfExists('debtor_bic', $data ?? [], null);
    ...
    {
        return $this->container['debtor_bic'];
    }

    /**
     * Sets debtor_bic
     *
     * @param string|null $debtor_bic debtor_bic
     *
     * @return self
     */
    public function setDebtorBic($debtor_bic)
    {
        if (is_null($debtor_bic)) {
            array_push($this->openAPINullablesSetToNull, 'debtor_bic');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('debtor_bic', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['debtor_bic'] = $debtor_bic;
    ...
    public function setDebtorName($debtor_name)
    {
        if (is_null($debtor_name)) {
            array_push($this->openAPINullablesSetToNull, 'debtor_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('debtor_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets execution_date
     *
     * @param \DateTime|null $execution_date execution_date
     *
     * @return self
     */

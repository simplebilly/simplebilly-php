...
class ContactInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('hint_en', $data ?? [], null);
        $this->setIfExists('role', $data ?? [], null);
        $this->setIfExists('role_en', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hint_en'] === null) {
            $invalidProperties[] = "'hint_en' can't be null";
        }
        if ($this->container['role'] === null) {
            $invalidProperties[] = "'role' can't be null";
        }
        if ($this->container['role_en'] === null) {
            $invalidProperties[] = "'role_en' can't be null";
        }
    ...
    {
        return $this->container['hint_en'];
    }

    /**
     * Sets hint_en
     *
     * @param string $hint_en hint_en
     *
     * @return self
     */
    public function setHintEn($hint_en)
    {
        if (is_null($hint_en)) {
            throw new \InvalidArgumentException('non-nullable hint_en cannot be null');
        }
        $this->container['hint_en'] = $hint_en;
    ...
    {
        return $this->container['role_en'];
    }

    /**
     * Sets role_en
     *
     * @param string $role_en role_en
     *
     * @return self
     */
    public function setRoleEn($role_en)
    {
        if (is_null($role_en)) {
            throw new \InvalidArgumentException('non-nullable role_en cannot be null');
        }
        $this->container['role_en'] = $role_en;

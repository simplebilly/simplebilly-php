...
/**
 * BudgetKategorie Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BudgetKategorie implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BudgetKategorie';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('differenz', $data ?? [], null);
        $this->setIfExists('goal', $data ?? [], null);
        $this->setIfExists('ist', $data ?? [], null);
        $this->setIfExists('kategorie', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['differenz'] === null) {
            $invalidProperties[] = "'differenz' can't be null";
        }
        if ($this->container['ist'] === null) {
            $invalidProperties[] = "'ist' can't be null";
        }
        if ($this->container['kategorie'] === null) {
            $invalidProperties[] = "'kategorie' can't be null";
        }
    ...
    {
        return $this->container['differenz'];
    }

    /**
     * Sets differenz
     *
     * @param string $differenz differenz
     *
     * @return self
     */
    public function setDifferenz($differenz)
    {
        if (is_null($differenz)) {
            throw new \InvalidArgumentException('non-nullable differenz cannot be null');
        }
        $this->container['differenz'] = $differenz;
     ...
     * Sets goal
     *
     * @param string|null $goal User-set monthly goal for the category, if any.
     *
     * @return self
     */
    ...
    {
        if (is_null($ist)) {
            throw new \InvalidArgumentException('non-nullable ist cannot be null');
        }
    ...
    {
        if (is_null($kategorie)) {
            throw new \InvalidArgumentException('non-nullable kategorie cannot be null');
        }

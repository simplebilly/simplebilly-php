...
class InvoiceType
{
    ...
    public const ADVANCE_PAYMENT = 'AdvancePayment';

    public const FINAL_SETTLEMENT = 'FinalSettlement';

    public const SPECIAL_BILLING = 'SpecialBilling';

    public const DOWN_PAYMENT_INVOICE = 'DownPaymentInvoice';

    public const PROFORMA = 'Proforma';

    public const RECURRING = 'Recurring';

    public const CANCELLATION_INVOICE = 'CancellationInvoice';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::SPECIAL_BILLING,
            self::DOWN_PAYMENT_INVOICE,
            self::PROFORMA,
            self::RECURRING,
            self::CANCELLATION_INVOICE
        ];
    }
}

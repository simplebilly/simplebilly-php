...
/**
 * NewVersionRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class NewVersionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NewVersionRequest';
     ...
     * Sets file_name
     *
     * @param string $file_name Storage key of the already-uploaded bytes.
     *
     * @return self
     */

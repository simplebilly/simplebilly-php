...
**promised_date** | **\DateTime** | Date promised to the customer. | [optional]
**status** | [**\OpenAPI\Client\Model\DeliveryDateStatus**](DeliveryDateStatus.md) | One of: promised | confirmed | rescheduled | fulfilled | late | cancelled | [optional]

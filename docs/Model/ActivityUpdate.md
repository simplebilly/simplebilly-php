...
------------ | ------------- | ------------- | -------------
**activity_type** | [**\OpenAPI\Client\Model\ActivityType**](ActivityType.md) | One of: call | email | meeting | task | note | [optional]
...
**status** | [**\OpenAPI\Client\Model\ActivityStatus**](ActivityStatus.md) | One of: open | done | cancelled | [optional]
